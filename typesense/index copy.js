  ...
  try {
    ...
    try {
      ...
      for (let mk = 0; mk < totalSegment.length; mk++) {
        ...
        } else if(Series == 'FUTCOM') {
          DisplayName = `${Name} ${FullData.value} ${StrikePrice}`
        } else if(Series == 'OPTFUT') {
          DisplayName = `${Name} ${FullData.value} ${OptionType == 3 ? 'CE' : 'PE'} ${StrikePrice}`
        } else if(Series == 'AUCSO') {
          DisplayName = `${Name} ${FullData.value} ${StrikePrice}`
        } else if(Series == 'FUTIDX') {
          DisplayName = `${Name} ${FullData.value} ${StrikePrice}`
        }else if(Series == 'FUTCUR') {
          // DisplayName = `${Name} ${FullData.value} ${StrikePrice}`
