  ...
  if (req.params.term == '') {
    ...
    try {
      ...
      if (searchResult == undefined) {
        ...
        instrumentsPE[instrumentsIndex_forCustomPrice].drawline = true
        let instrumentsCE = getapidataCE.slice(instrumentsIndexCE - 10 < 0?0:instrumentsIndexCE - 10, instrumentsIndexCE + 10 )
        const [responsePE1510,responseCE1510] = await axios.all([
          axios.post(`${process.env.APIMarketDataURL}/instruments/quotes`,{
            instruments:instrumentsPE,
            "xtsMessageCode": 1510,
            "publishFormat": "JSON"
        ...
        instrumentsPE = instrumentsPE.map((x , i) =>{     
          ...
          return {OpenInterest: OpenInterest.OpenInterest?OpenInterest.OpenInterest:0,...x,PriceBand: null}
        })
...
// Socket Testing //
    ...
    var socketInitRequest = {
      ...
      publishFormat: 'JSON',
      broadcastMode: 'Full',
      token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOiJUQUJUUkVFMDkiLCJtZW1iZXJJRCI6IkdJTEwiLCJzb3VyY2UiOiJFTlRFUlBSSVNFTU9CSUxFIiwiaWF0IjoxNjcyMDU2OTM2LCJleHAiOjE2NzIxNDMzMzZ9.wTDT8YySGa_16ZD6HqwFQF5HN0cKnCk3HhWtEJRBHu4', // Token Generated after successful LogIn
    };
    xtsMarketDataWS.init(socketInitRequest);
   console.log('marketSocket', xtsMarketDataWS)
    xtsMarketDataWS.onConnect((connectData) => {
      console.log('saroMarket', connectData);
    });
    ...
    console.log('interactiveSocket', xtsInteractiveWS)
    xtsInteractiveWS.onConnect((connectData) => {
      console.log('saroInteractive', connectData);
    });
